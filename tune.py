...
class Tune():
    ...
    def __init__(self,path_to_song, name, artist):
        ...
        self.find_lyrics(name, artist)

    def find_lyrics(name, artist):
        self.songName = name
        self.artist = artist
        self.lyrics = self.harvest_lyrics()
        self.timed_lyrics = self.harvest_lrc()    
...
bs = Tune('Blank Space.mp3', 'Blank Space', 'Taylor Swift')
print bs.get_json()
